...
% ADP3- + CrP2- + H+ = ATP4- + Cr
% Does not exist in isolated mitochondia 

J_CK = 0; % X_CK * (Kapp_CK * ADP_c * CrP_c - ATP_c * Cr_c);
...
%% Adenylate kinase 
% 2 ADP3- = ATP4- + AMP2- 
% Does not exist in isolated mitochondria

J_AK = 0; %X_AK * (Kapp_AK * ADP_c^2 - AMP_c * ATP_c); 
...
% Prevent NADH from going negative 
if (dNADH_x + NADH_x < 0)
    dNADH_x = -NADH_x/2;
end
