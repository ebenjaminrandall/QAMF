...
E_ANT = 0.1;       % mol (L mito)^(-1)    %1.5*0.006762/7.2679e-003*(0.70e-1);
...
hfig7 = figure(7);
clf
plot(X_AtC*1e3,CrP_ATP,'b','linewidth',linethickness)
...
hfig8 = figure(8);
clf
plot(X_AtC*1e3,Pi_c*1e3,'b','linewidth',linethickness)
xlabel('ATP consumption rate (mmol (s * L cell)^{-1})')
